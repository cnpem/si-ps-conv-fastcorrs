...
/* Generated from ../O.Common/si_ps_conv_fastcorrs.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_pySetupReg, pvar_func_rsrvRegistrar,
...
int si_ps_conv_fastcorrs_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/ABTLUS/gustavo.reis/EPICS/IOCs/si_ps_conv_fastcorrs";
    ...
    runRegistrarOnce(pvar_func_pySetupReg);
...
/* si_ps_conv_fastcorrs_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: si_ps_conv_fastcorrs_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(si_ps_conv_fastcorrs_registerRecordDeviceDriver(*iocshPpdbbase));
}
